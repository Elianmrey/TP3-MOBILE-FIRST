...
import ThemeToggle from './components/ThemeToggle';import './App.css';
...
export default function App() {
  ...
  function removeCategory (category) {
    if (categories.includes(category)) {
      ...
      //O Comentario anterior esaa colocado no codigo para evitar que o Eslint detecte a variavel 'ignored'
