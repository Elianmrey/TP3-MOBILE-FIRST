            ...
            <div className="info">
                ...
                <ul className="specifications">
                    <li>Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. Nobis odit porro odio placeat beatae et, quod illo corporis possimus ipsam explicabo, officiis corrupti omnis quaerat libero veniam ea eius ipsum.</li>
