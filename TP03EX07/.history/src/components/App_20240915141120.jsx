    ...
    const elements = [
        {
            ...
            description: "Um produto de alta qualidade Lorem ipsum dolor, sit amet consectetur adipisicing elit. Itaque neque nemo ut asperiores sequi corrupti nulla doloremque iure. Voluptates dolorum repellendus libero quia incidunt modi rem optio est fugiat labore.",
            footer: "R$ 199,99 A vista ou em até 12X de 16,"
        }]
    return (
