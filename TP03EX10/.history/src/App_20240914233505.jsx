...
export default function App() {
  ...
  const suggestions = [
    { photo: 'https://img.freepik.com/fotos-premium/homem-rapado-com-barba-e-um-casaco-sorrindo-para-uma-foto-generativa-ai_1035767-13015.jpg?semt=ais_hybrid', name: 'Ana', mutualFriend: 'João' },
    { photo: 'https://img.freepik.com/fotos-premium/homem-rapado-com-barba-e-um-casaco-sorrindo-para-uma-foto-generativa-ai_1035767-13015.jpg?semt=ais_hybrid', name: 'Pedro', mutualFriend: 'Carlos' },
