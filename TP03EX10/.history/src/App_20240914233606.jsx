...
export default function App() {
  ...
  const suggestions = [
    { photo: 'https://img.freepik.com/fotos-premium/fotografia-de-um-astronomo-sorridente-em-fundo-solido_810293-351875.jpg?semt=ais_hybrid', name: 'Ana', mutualFriend: 'João' },
